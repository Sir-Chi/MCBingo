...
attribute @a[tag=purpleGuyToTeleport,limit=1] minecraft:movement_speed base reset
attribute @a[tag=purpleGuyToTeleport,limit=1] minecraft:jump_strength base reset
...
schedule function bingo:start/spawn_points/spawn_point_purple 5s
