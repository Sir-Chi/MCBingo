...
$execute as @s[team=$(team)] run execute in bingo:bingo_card at @e[type=marker,tag=card_item,tag=$(item)] run place template bingo:card_extras/$(team)/$(team)_1 ~-3 ~1 ~-4