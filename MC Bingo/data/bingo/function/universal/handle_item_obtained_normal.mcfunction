...
$execute as @s[team=blue] run return run execute in bingo:bingo_card at @e[type=marker,tag=card_item,tag=$(item)] run place template bingo:card_extras/blue_card_marker ~-3 ~1 ~-4
$execute as @s[team=red] run return run execute in bingo:bingo_card at @e[type=marker,tag=card_item,tag=$(item)] run place template bingo:card_extras/red_card_marker ~-3 ~1 ~7
$execute as @s[team=green] run return run execute in bingo:bingo_card at @e[type=marker,tag=card_item,tag=$(item)] run place template bingo:card_extras/green_card_marker ~8 ~1 ~8
$execute as @s[team=yellow] run return run execute in bingo:bingo_card at @e[type=marker,tag=card_item,tag=$(item)] run place template bingo:card_extras/yellow_card_marker ~9 ~1 ~-4