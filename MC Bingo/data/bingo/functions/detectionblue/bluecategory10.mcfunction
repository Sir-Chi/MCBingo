...
execute if score Lockout GameSetup matches 0 if score greendye BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score greendye BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Green Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score greendye BlueItems matches 1 if score greendye RedItems matches 0 if score greendye GreenItems matches 0 if score greendye YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score greendye BlueItems matches 1 if score greendye RedItems matches 0 if score greendye GreenItems matches 0 if score greendye YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Green Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score limedye BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score limedye BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Lime Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score limedye BlueItems matches 1 if score limedye RedItems matches 0 if score limedye GreenItems matches 0 if score limedye YellowItems matches 0 run scoreboard players add BlueTeam Score 1
