...
execute if score Lockout GameSetup matches 0 if score bottle BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score bottle BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Glass Bottle! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score bottle BlueItems matches 1 if score bottle RedItems matches 0 if score bottle GreenItems matches 0 if score bottle YellowItems matches 0 run scoreboard players add BlueTeam Score 1
