...
execute if score Lockout GameSetup matches 0 if score bottle BlueItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score bottle BlueItems matches 1 if score bottle RedItems matches 0 if score bottle GreenItems matches 0 if score bottle YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
