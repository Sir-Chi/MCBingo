...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score bone GreenItems matches 1 run tellraw @p ["",{"selector":"@a[team=green]","color":"green"},{"text":" obtained "},{"text":"Bone! ","color":"gold"},{"score":{"name":"@p[team=green]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score bone GreenItems matches 1 if score bone RedItems matches 0 if score bone BlueItems matches 0 if score bone YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score greydye GreenItems matches 1 run tellraw @p ["",{"selector":"@a[team=green]","color":"green"},{"text":" obtained "},{"text":"Grey Dye! ","color":"gold"},{"score":{"name":"@p[team=green]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score greydye GreenItems matches 1 if score greydye RedItems matches 0 if score greydye BlueItems matches 0 if score greydye YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
