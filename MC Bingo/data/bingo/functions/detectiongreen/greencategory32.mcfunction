...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score kelp GreenItems matches 1 run tellraw @p ["",{"selector":"@a[team=green]","color":"green"},{"text":" obtained "},{"text":"Kelp! ","color":"gold"},{"score":{"name":"@p[team=green]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"timer"}}," : ",{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score kelp GreenItems matches 1 if score kelp RedItems matches 0 if score kelp BlueItems matches 0 if score kelp YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score seagrass GreenItems matches 1 run tellraw @p ["",{"selector":"@a[team=green]","color":"green"},{"text":" obtained "},{"text":"Seagrass! ","color":"gold"},{"score":{"name":"@p[team=green]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"timer"}}," : ",{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score seagrass GreenItems matches 1 if score seagrass RedItems matches 0 if score seagrass BlueItems matches 0 if score seagrass YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score seapickle GreenItems matches 1 run tellraw @p ["",{"selector":"@a[team=green]","color":"green"},{"text":" obtained "},{"text":"Sea Pickle! ","color":"gold"},{"score":{"name":"@p[team=green]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"timer"}}," : ",{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score seapickle GreenItems matches 1 if score seapickle RedItems matches 0 if score seapickle BlueItems matches 0 if score seapickle YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
