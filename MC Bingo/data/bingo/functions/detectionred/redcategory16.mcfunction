...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score diamond RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Diamond! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score diamond RedItems matches 1 if score diamond BlueItems matches 0 if score diamond GreenItems matches 0 if score diamond YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Lockout GameSetup matches 1 if score diamondhoe RedItems matches 1 if score diamondhoe BlueItems matches 0 if score diamondhoe GreenItems matches 0 if score diamondhoe YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score diamondaxe RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Diamond Axe! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score diamondaxe RedItems matches 1 if score diamondaxe BlueItems matches 0 if score diamondaxe GreenItems matches 0 if score diamondaxe YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
