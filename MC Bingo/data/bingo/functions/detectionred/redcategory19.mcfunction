...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score fern RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Fern! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score fern RedItems matches 1 if score fern BlueItems matches 0 if score fern GreenItems matches 0 if score fern YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score vines RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Vines! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score vines RedItems matches 1 if score vines BlueItems matches 0 if score vines GreenItems matches 0 if score vines YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score deadbush RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Dead Bush! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score deadbush RedItems matches 1 if score deadbush BlueItems matches 0 if score deadbush GreenItems matches 0 if score deadbush YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
