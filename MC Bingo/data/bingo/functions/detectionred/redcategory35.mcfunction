...
execute if score Lockout GameSetup matches 0 if score cookedcod RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score cookedcod RedItems matches 1 if score cookedcod BlueItems matches 0 if score cookedcod GreenItems matches 0 if score cookedcod YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 0 if score campfire RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score campfire RedItems matches 1 if score campfire BlueItems matches 0 if score campfire GreenItems matches 0 if score campfire YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 0 if score crossbow RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score crossbow RedItems matches 1 if score crossbow BlueItems matches 0 if score crossbow GreenItems matches 0 if score crossbow YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
