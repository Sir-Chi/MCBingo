...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score goldsword RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Golden Sword! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score goldsword RedItems matches 1 if score goldsword BlueItems matches 0 if score goldsword GreenItems matches 0 if score goldsword YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score clock RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Clock! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score clock RedItems matches 1 if score clock BlueItems matches 0 if score clock GreenItems matches 0 if score clock YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
...
execute if score Teams GameSetup matches 0 if score Lockout GameSetup matches 0 if score poweredrail RedItems matches 1 run tellraw @p ["",{"selector":"@a[team=red]","color":"red"},{"text":" obtained "},{"text":"Powered Rail! ","color":"gold"},{"score":{"name":"@p[team=red]","objective":"Score"}}," in ",{"score":{"name":"minutes","objective":"time"}}," : ",{"score":{"name":"seconds","objective":"time"}}]
...
execute if score Lockout GameSetup matches 1 if score poweredrail RedItems matches 1 if score poweredrail BlueItems matches 0 if score poweredrail GreenItems matches 0 if score poweredrail YellowItems matches 0 run execute at @a run playsound entity.firework_rocket.launch ambient @p ~ ~ ~ 1 1 1
