...
execute if score Lockout GameSetup matches 0 if score cocoabeans RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score cocoabeans RedItems matches 1 if score cocoabeans BlueItems matches 0 if score cocoabeans GreenItems matches 0 if score cocoabeans YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 0 if score cookie RedItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score cookie RedItems matches 1 if score cookie BlueItems matches 0 if score cookie GreenItems matches 0 if score cookie YellowItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
