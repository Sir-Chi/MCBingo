...
execute if score Lockout GameSetup matches 0 if score fern YellowItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score fern YellowItems matches 1 if score fern RedItems matches 0 if score fern GreenItems matches 0 if score fern BlueItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 0 if score vines YellowItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score vines YellowItems matches 1 if score vines RedItems matches 0 if score vines GreenItems matches 0 if score vines BlueItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 0 if score deadbush YellowItems matches 1 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
...
execute if score Lockout GameSetup matches 1 if score deadbush YellowItems matches 1 if score deadbush RedItems matches 0 if score deadbush GreenItems matches 0 if score deadbush BlueItems matches 0 run execute at @a run playsound minecraft:block.note_block.iron_xylophone ambient @p ~ ~ ~ 1 0.5 1
