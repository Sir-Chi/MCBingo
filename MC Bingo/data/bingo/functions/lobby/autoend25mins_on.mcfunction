...
data merge block -18 279 -5 {Text1:"[\"\"]",Text2:"{\"text\":\"25 Mins\",\"bold\":true,\"color\":\"white\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger signs set 9\"}}",Text3:"{\"text\":\"ON\",\"bold\":true,\"color\":\"dark_green\"}"}
