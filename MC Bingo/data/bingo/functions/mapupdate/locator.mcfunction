...
execute at @p[tag=playerThatIsMapUpdating] unless entity @p[tag=playerThatIsMapUpdating,x=10,dx=2,y=273,dy=2,z=-9,dz=2] run summon area_effect_cloud ~ ~ ~ {Tags:["whereToTpBackTo"],Duration:2000,NoGravity:true}
