...
execute as @a[team=blue] if score @s Score = #Leader Score if score minutes timer matches 25 if score 25Mins GameSetup matches 1 run tellraw @a ["",{"selector":"@a[team=blue]"},{"text":" got "},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" items, the most in 25 mins!"}]
...
summon firework_rocket -7 106 -3 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;524543],FadeColors:[I;7395839]}]}}}}
summon firework_rocket 5 106 -3 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;524543],FadeColors:[I;7395839]}]}}}}
summon firework_rocket 5 106 -15 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;524543],FadeColors:[I;7395839]}]}}}}
summon firework_rocket -7 106 -15 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;524543],FadeColors:[I;7395839]}]}}}}
