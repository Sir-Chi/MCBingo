...
execute if score minutes timer matches ..24 if score 25Mins GameSetup matches 1 if score @p[team=green] Score matches 25 run tellraw @a ["",{"selector":"@a[team=green]"},{"text":" got "},{"score":{"name":"@p[team=green]","objective":"Score"}},{"text":" items, the most in under 25 mins!"}]
execute as @a[team=green] if score @s Score = #Leader Score if score minutes timer matches 25 if score 25Mins GameSetup matches 1 if score GreenTeam Score matches 25 run tellraw @a ["",{"selector":"@a[team=green]"},{"text":" got "},{"score":{"name":"GreenTeam","objective":"Score"}},{"text":" items, the most in 25 mins!"}]
execute as @a[team=green] if score @s Score = #Leader Score if score minutes timer matches 25 if score 25Mins GameSetup matches 1 if score @p[team=green] Score matches 25 run tellraw @a ["",{"selector":"@a[team=green]"},{"text":" got "},{"score":{"name":"@p[team=green]","objective":"Score"}},{"text":" items, the most in 25 mins!"}]
