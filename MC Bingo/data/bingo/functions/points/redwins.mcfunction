...
##25Mins Bingo Win
execute if score minutes timer matches ..24 if score 25Mins GameSetup matches 1 if score RedTeam Score matches 25 run tellraw @a ["",{"selector":"@a[team=red]"},{"text":" got "},{"score":{"name":"RedTeam","objective":"Score"}},{"text":" items, the most in under 25 mins!"}]
execute as @a[team=red] if score @s Score = #Leader Score if score minutes timer matches 25 if score 25Mins GameSetup matches 1 run tellraw @a ["",{"selector":"@a[team=red]"},{"text":" got "},{"score":{"name":"RedTeam","objective":"Score"}},{"text":" items, the most in 25 mins!"}]
...
summon firework_rocket -7 106 -3 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16711680],FadeColors:[I;5899268]}]}}}}
summon firework_rocket 5 106 -3 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16711680],FadeColors:[I;5899268]}]}}}}
summon firework_rocket 5 106 -15 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16711680],FadeColors:[I;5899268]}]}}}}
summon firework_rocket -7 106 -15 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16711680],FadeColors:[I;5899268]}]}}}}
