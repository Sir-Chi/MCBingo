...
execute as @a[team=yellow] if score @s Score = #Leader Score if score minutes timer matches 25 if score 25Mins GameSetup matches 1 run tellraw @a ["",{"selector":"@a[team=yellow]"},{"text":" got "},{"score":{"name":"YellowTeam","objective":"Score"}},{"text":" items, the most in 25 mins!"}]
...
summon firework_rocket -7 106 -3 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16775936],FadeColors:[I;13931269]}]}}}}
summon firework_rocket 5 106 -3 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16775936],FadeColors:[I;13931269]}]}}}}
summon firework_rocket 5 106 -15 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16775936],FadeColors:[I;13931269]}]}}}}
summon firework_rocket -7 106 -15 {LifeTime:20,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Colors:[I;16775936],FadeColors:[I;13931269]}]}}}}
