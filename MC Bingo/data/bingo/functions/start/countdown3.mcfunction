...
execute if score PVP GameSetup matches 1 run tellraw @p ["",{"text":"PvP Mode is","color":"red"},{"text":" ACTIVE! ","bold":true,"color":"red"},{"text":"You are close to the other teams","color":"red"}]
