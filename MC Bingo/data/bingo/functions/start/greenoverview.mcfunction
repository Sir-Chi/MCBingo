...
execute at @p[tag=greenGuyToTeleport] align xyz run tp @p[tag=greenGuyToTeleport] ~0.5 260 ~0.5
execute as @p[tag=greenGuyToTeleport] at @p[tag=greenGuyToTeleport] positioned ~ ~ ~ run fill ~-2 258 ~-2 ~2 263 ~2 barrier hollow
execute at @p[tag=greenGuyToTeleport] align xyz run tp @p[tag=greenGuyToTeleport] ~0.5 260 ~0.5
