...
execute at @p[tag=redGuyToTeleport] align xyz run tp @p[tag=redGuyToTeleport] ~0.5 260 ~0.5
execute as @p[tag=redGuyToTeleport] at @p[tag=redGuyToTeleport] positioned ~ ~ ~ run fill ~-2 258 ~-2 ~2 263 ~2 barrier hollow
execute at @p[tag=redGuyToTeleport] align xyz run tp @p[tag=redGuyToTeleport] ~0.5 260 ~0.5
