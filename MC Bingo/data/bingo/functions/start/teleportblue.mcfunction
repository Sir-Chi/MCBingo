...
execute if score BlueTeam TeamCount matches 1 run data merge block -29 113 -9 {auto:1b}
execute if score BlueTeam TeamCount matches 1 run data merge block -30 113 -9 {auto:1b}
