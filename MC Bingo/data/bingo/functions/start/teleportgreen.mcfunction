...
execute if score GreenTeam TeamCount matches 1 run data merge block -29 109 -9 {auto:1b}
execute if score GreenTeam TeamCount matches 1 run data merge block -30 109 -9 {auto:1b}
