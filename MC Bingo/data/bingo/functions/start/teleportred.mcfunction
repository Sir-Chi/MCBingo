...
execute if score RedTeam TeamCount matches 1 run data merge block -29 111 -9 {auto:1b}
execute if score RedTeam TeamCount matches 1 run data merge block -30 111 -9 {auto:1b}
