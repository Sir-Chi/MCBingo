...
execute if score YellowTeam TeamCount matches 1 run data merge block -29 107 -9 {auto:1b}
execute if score YellowTeam TeamCount matches 1 run data merge block -30 107 -9 {auto:1b}
