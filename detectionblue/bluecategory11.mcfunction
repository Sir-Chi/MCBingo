...
execute if score Lockout GameSetup matches 0 if score lapislazuli BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score lapislazuli BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Lapis Lazuli! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score lapislazuli BlueItems matches 1 if score lapislazuli RedItems matches 0 if score lapislazuli GreenItems matches 0 if score lapislazuli YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score lapislazuli BlueItems matches 1 if score lapislazuli RedItems matches 0 if score lapislazuli GreenItems matches 0 if score lapislazuli YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Lapis Lazuli! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score purpledye BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score purpledye BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Purple Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score purpledye BlueItems matches 1 if score purpledye RedItems matches 0 if score purpledye GreenItems matches 0 if score purpledye YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score purpledye BlueItems matches 1 if score purpledye RedItems matches 0 if score purpledye GreenItems matches 0 if score purpledye YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Purple Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score cyandye BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score cyandye BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Cyan Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score cyandye BlueItems matches 1 if score cyandye RedItems matches 0 if score cyandye GreenItems matches 0 if score cyandye YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score cyandye BlueItems matches 1 if score cyandye RedItems matches 0 if score cyandye GreenItems matches 0 if score cyandye YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Cyan Dye! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
