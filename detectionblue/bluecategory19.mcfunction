...
execute if score Lockout GameSetup matches 0 if score fern BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score fern BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Fern! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score fern BlueItems matches 1 if score fern RedItems matches 0 if score fern GreenItems matches 0 if score fern YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score fern BlueItems matches 1 if score fern RedItems matches 0 if score fern GreenItems matches 0 if score fern YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Fern! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score vines BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score vines BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Vines! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score vines BlueItems matches 1 if score vines RedItems matches 0 if score vines GreenItems matches 0 if score vines YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score vines BlueItems matches 1 if score vines RedItems matches 0 if score vines GreenItems matches 0 if score vines YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Vines! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score deadbush BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score deadbush BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Dead Bush! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score deadbush BlueItems matches 1 if score deadbush RedItems matches 0 if score deadbush GreenItems matches 0 if score deadbush YellowItems matches 0 run scoreboard players add BlueTeam Score 1
