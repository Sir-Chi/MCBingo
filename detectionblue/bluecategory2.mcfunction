...
execute if score Lockout GameSetup matches 0 if score nametag BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score nametag BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Name Tag! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score nametag BlueItems matches 1 if score nametag RedItems matches 0 if score nametag GreenItems matches 0 if score nametag YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score nametag BlueItems matches 1 if score nametag RedItems matches 0 if score nametag GreenItems matches 0 if score nametag YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Name Tag! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score saddle BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score saddle BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Saddle! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score saddle BlueItems matches 1 if score saddle RedItems matches 0 if score saddle GreenItems matches 0 if score saddle YellowItems matches 0 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 1 if score saddle BlueItems matches 1 if score saddle RedItems matches 0 if score saddle GreenItems matches 0 if score saddle YellowItems matches 0 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Saddle! ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 0 if score enchantedbook BlueItems matches 1 run scoreboard players add BlueTeam Score 1
...
execute if score Lockout GameSetup matches 0 if score enchantedbook BlueItems matches 1 run tellraw @a ["",{"text":"Blue Team","color":"blue"},{"text":" obtained "},{"text":"Enchanted Book!  ","color":"gold"},{"score":{"name":"BlueTeam","objective":"Score"}},{"text":" in "},{"score":{"name":"minutes","objective":"timer"}},{"text":":"},{"score":{"name":"seconds","objective":"timer"}}]
...
execute if score Lockout GameSetup matches 1 if score enchantedbook BlueItems matches 1 if score enchantedbook RedItems matches 0 if score enchantedbook GreenItems matches 0 if score enchantedbook YellowItems matches 0 run scoreboard players add BlueTeam Score 1
